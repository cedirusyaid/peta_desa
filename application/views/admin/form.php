        ...
        <form action="<?= isset($lokasi) ? site_url('admin/update/'.$lokasi->lokasi_id) : site_url('admin/store') ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="desa_id" required>
                    <!-- <option value="">Pilih Desa x</option> -->
                    <?php $kecamatan_id_last="";  foreach($all_desa as $ds): ?>
                        <?php if ($kecamatan_id_last!=$ds->kecamatan_id): ?>
                        <option value="" disabled>
                            - KECAMATAN <?php echo $ds->kecamatan_nama; ?> -
                        </option>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="lokasi_lat" name="lokasi_lat" value="<?= isset($lokasi) ? $lokasi->lokasi_lat : set_value('lokasi_lat') ?>" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="lokasi_long" name="lokasi_long" value="<?= isset($lokasi) ? $lokasi->lokasi_long : set_value('lokasi_long') ?>" required>
                </div>
            </div>
